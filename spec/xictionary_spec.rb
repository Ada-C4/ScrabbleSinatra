...
#bad example of rspec - tests make more than one assertion, check numbers twice, create more data than needed
    describe "#find_word" do
      ...
      it "returns false if input is not a string" do
        ...
        expect(@dictionary.find_word({hey: "there"})).to be false
      end
    end
  end
end
